...
import { getAllPosts, getTag } from '../../utils/wpGraph';
import Header from '../../components/Header';

const Tag = ({ posts, tagDetails }) => {
  const tagDatafirstCol = posts?.nodes?.slice(0, 4);
  const tagDatasecCol = posts?.nodes?.slice(5, 9);
  const tagDataSlider = posts?.nodes?.slice(10, 14);
  const tagDesc = tagDetails?.description || '';
            ...
            <div className="col-md-8">
              <aside className="wrapper__list__article ">
                ...
                <div
                  ...
                  dangerouslySetInnerHTML={{ __html: tagDesc }}
                ></div>
                <br />
                <br />
                <br />
