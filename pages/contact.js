                            ...
                            <div className="row">
                                <div className="col-md-6">
                                    <div className="form-group form-group-name">
                                        ...
                                        <input type="text" className="form-control rounded-2" name="name" required="" />
                                ...
                                <div className="col-md-6">
                                    <div className="form-group form-group-name">
                                        ...
                                        <input type="email" className="form-control rounded-2" name="email" required="" />
                                ...
                                <div className="col-md-6">
                                    <div className="form-group form-group-name">
                                        ...
                                        <input type="text" className="form-control rounded-2" name="website" required="" />
                                ...
                                <div className="col-md-6">
                                    <div className="form-group form-group-name">
                                        ...
                                        <input type="text" className="form-control rounded-2" name="subject" required="" />
                                ...
                                <div className="col-md-12">
                                    <div className="form-group">
                                        ...
                                        <textarea className="form-control rounded-2" rows="8" name="message"></textarea>
                                    </div>
                                    <div className="form-group float-right mb-4">
                                        <button type="submit" className="btn btn-primary rounded-2">Submit</button>
                                    </div>
                                </div>
                            </div>
                        </div>
